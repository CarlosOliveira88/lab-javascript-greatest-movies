...
function howManyMovies(moviesArray) {
  ...
  moviesArray.map((moviesArray) => {
    ...
    if (moviesArray.director.toUpperCase() === "STEVEN SPIELBERG" && moviesArray.genre.includes("Drama") === true) {
      console.log(moviesArray.title)
      dramaMovies.push(moviesArray.title)
    }
...
function scoresAverage(moviesArray) {
  ...
  moviesArray.map((moviesArray) => {
    ...
    totalScore += moviesArray.score;

  })

  let promedio = totalScore / moviesArray.length

  // console.log("score total: " + totalScore);
  // console.log("score promedio: " + promedio.toFixed(2));
  // console.log("score unico valor: " + promedio.toFixed(0));
...
function dramaMoviesScore(moviesArray) {
  ...
  moviesArray.map((moviesArray) => {
    ...
    if (moviesArray.genre.includes("Drama") === true) {
      dramaMovies.push(moviesArray);
    }
  })

  let promedio = scoresAverage(dramaMovies);
...
function orderByYear(moviesArray) {
  ...
  let newArray = moviesArray.slice().sort((a, b) => {
    if (a.year !== b.year) {
